...
translate_table2 = {
    ...
    'handphone_status' : 9,
    'kamera_status' : 13,
    'video_kamera_status' : 17,
    'laptop_pj1_status' : 21,
    'laptop_pj2_status' : 25,
    'widescreen_status' : 29,
}
...
if __name__ == '__main__':
    ...
    with st.form(key='data-form3', clear_on_submit=False):
        ...
        st.text_area('Catatan dan informasi penting', key='Catatan', help='Tuliskan catatan dan informasi penting disini', value='')
    ...
    if form3_submitbutton:
        st.success('Berhasil mengubah nama pembuat')
    ...
    with st.form(key='data-form4', clear_on_submit=False):
        ...
        form4_submitbutton = st.form_submit_button(label='Check')
    if form4_submitbutton:
    ...
    with st.form(key='data-form5', clear_on_submit=False):
        ...
        st.text_area('Catatan dan informasi penting', key='Catatan2', help='Tuliskan catatan dan informasi penting disini', value='')
        
        form5_submitbutton = st.form_submit_button(label='Check')
        st.markdown("<p style='font-size:10px'>*Klik tombol 'Check' untuk mengubah nama pembuat</p>", unsafe_allow_html=True)
    if form5_submitbutton:
        st.success('Berhasil mengubah nama pembuat')
